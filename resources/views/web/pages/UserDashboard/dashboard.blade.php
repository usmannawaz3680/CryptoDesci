              ...
              <div class="p-4 md:p-6">
                <div class="flex flex-col md:flex-row md:items-center flex-wrap">
                  ...
                  <div class="flex items-center mb-4 md:mb-0">
                    ...
                    <div class="ml-4">
                      <h2 class="text-lg md:text-xl font-medium">User-d6270</h2>
                    </div>
                  </div>
                ...
                <div class="border border-neutral-600 rounded-lg p-4 md:p-6 bg-crypto-accent/80">
                  ...
                  <div>
                    <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                      <ul
                        class="flex flex-wrap -mb-px text-sm font-medium text-center gap-3"
                        id="markets-tab"
                        data-tabs-toggle="#markets-tab-content"
