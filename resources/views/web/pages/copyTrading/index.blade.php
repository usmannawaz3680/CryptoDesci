...
@section('content')
    ...
    <div id="happytrading-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="relative bg-crypto-accent rounded-lg shadow border border-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b border-gray-700">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-white">HappyTrading</h3>
                            ...
                            <div class="text-sm text-gray-400 mt-1">Member since: Jan 2022 • Last active: 2 hours ago</div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                                ...
                                <div class="  rounded-lg p-4 text-center">
                                    <div class="text-2xl font-bold text-white">$94,539.65</div>
                                    <div class="text-xs text-gray-400">Total PnL</div>
                                </div>
                                <div class="  rounded-lg p-4 text-center">
                                    <div class="text-2xl font-bold text-crypto-primary">2,156</div>
                                    <div class="text-xs text-gray-400">Copiers</div>
                                </div>
                                <div class="  rounded-lg p-4 text-center">
                                    <div class="text-2xl font-bold text-white">67.8%</div>
                        ...
                        <div>
                            ...
                            <div class="  rounded-lg p-4 space-y-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-white font-medium">$78,456.89</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-400">Max Drawdown</span>
                                    <span class="text-red-400 font-medium">-12.34%</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-400">Avg Holding Time</span>
                                    <span class="text-white font-medium">2.5 days</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-green-400 font-medium">2.34</span>
                                </div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="  rounded-lg p-4 space-y-3">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-crypto-primary font-medium">10%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
