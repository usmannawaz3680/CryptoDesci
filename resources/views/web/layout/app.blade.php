                    ...
                    <div class="flex items-center gap-4 ml-auto">
                        <div class="xl:hidden flex gap-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <div class="absolute -right-10 w-44 bg-white rounded-md shadow-lg z-20 hidden group-hover:block dark:bg-neutral-800">
                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                            <li><a href="/dashboard" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Dashboard</a>
                                            </li>
                                            <li><a href="/profile" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Profile</a>
                                            </li>
                                            <li><a href="/dashboard/assets" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Wallet</a>
                                            </li>
                                            <li>
                            ...
                            @if (auth('web')->guest())
                                ...
                                <a href="/register" class="bg-crypto-primary text-black font-normal px-3 py-1 rounded hover:bg-crypto-primary/80 transition">Signup</a>
                            @endif
                        </div>
                                ...
                                <div id="dropdownNavbar" class="z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-sm shadow-sm max-w-xs dark:bg-neutral-800 dark:divide-gray-600 p-4">
                                    <div class="text-sm font-medium space-y-3 px-2">
                                        <a href="{{ route('web.tradingbots') }}" class="hover:text-crypto-primary group">
                                            ...
                                            <span class="text-gray-500 text-xs duration-75  group-hover:text-crypto-primary">Trade
                                        ...
                                        <a href="{{ route('web.copytrading') }}" class="hover:text-crypto-primary group">
                                            ...
                                            <span class="text-gray-500 text-xs duration-75  group-hover:text-crypto-primary">Follow
                    ...
                    <div class="hidden xl:flex items-center space-x-3 ml-auto">
                        <div>
                            <form action="{{ url('/') }}" method="get">
                                <input type="search" value="{{ request()->input('search', '') }}" name="search" id="search"
                            ...
                            <div class="relative group">
                                ...
                                <div class="absolute -right-10 w-44 bg-white rounded-md shadow-lg z-20 hidden group-hover:block dark:bg-neutral-800">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                        ...
                                        <li><a href="{{ route('user.assets') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700">Wallet</a>
                                        </li>
                                        <li>
                                            <form method="POST" action="{{ route('logout') }}">
                                                @csrf
